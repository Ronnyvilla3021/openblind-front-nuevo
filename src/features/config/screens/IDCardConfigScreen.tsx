      ...
      <div className="feat-idcard-config-content">
        ...
        >
          <div className="feat-idcard-config-section">
            {/* Nombre Completo */}
            <div
              className="feat-idcard-config-item"
        ...
        >
          <div className="feat-idcard-config-section">
            ...
            <div
              className="feat-idcard-slider-container"
              data-option="qrDiasExpiracion"
            >
              <label>Tiempo de expiración del QR</label>
              <div className="feat-idcard-days-display">
                {config.qrDiasExpiracion} día
                {config.qrDiasExpiracion !== 1 ? "s" : ""}
              </div>
              <input
                type="range"
                min="1"
              ...
              <div className="feat-idcard-quick-presets">
                <button
                  ...
                  className={
                    config.qrDiasExpiracion === 7 ? "feat-idcard-active" : ""
                  }
                >
                  1 semana
                </button>
                <button
                  ...
                  className={
                    config.qrDiasExpiracion === 30 ? "feat-idcard-active" : ""
                  }
                >
                  1 mes
                </button>
                <button
                  ...
                  className={
                    config.qrDiasExpiracion === 90 ? "feat-idcard-active" : ""
                  }
                >
                  3 meses
                </button>
